...
The [issue tracker](https://github.com/GWP01/platform/issues) is the preferred channel for [bug reports](#bug-reports), [features requests](#feature-requests) and [submitting pull requests](#pull-requests), but please respect the following restrictions:
...
* Please **do not** open issues or pull requests regarding the code in  [`@coreui/coreui`](https://github.com/GWP01/aboutus) (open them in their respective repositories).
...
1. [Fork](https://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/GWP01/platform.git
   ```
